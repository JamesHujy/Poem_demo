...
def get_prob(context, topk, genre, title):
    ...
    tokenizer = tokenization_bert.BertTokenizer(vocab_file='cache/vocab_with_title.txt')

    model_config = pytorch_pretrained_bert.GPT2Config.from_json_file('cache/model_config.json')
    model_state_dict = torch.load('cache/model/model_epoch_1.pt')
